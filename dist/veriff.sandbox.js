...
var createSession = __webpack_require__(5);
...
var Veriff = function Veriff(apiKey) {
  ...
  return {
    ...
    person: {},
    features: features,
    env: {"ENV":"sandbox","VERIFF_API_URL":"https://sandbox.veriff.me"}.ENV,
...
var API_URL = {"ENV":"sandbox","VERIFF_API_URL":"https://sandbox.veriff.me"}.VERIFF_API_URL;
